...
export const Icons = {
  ...
  Folder:   (p) => <Icon {...p}><path d="M3.5 7.5A1.5 1.5 0 015 6h4.2a1.5 1.5 0 011.1.5L11.7 8H19a1.5 1.5 0 011.5 1.5v8A1.5 1.5 0 0119 19H5a1.5 1.5 0 01-1.5-1.5v-10z"/><path d="M3.5 11h17"/></Icon>,
  ...
  Star:     (p) => <Icon {...p}><path d="M12 3.5l2.6 5.3 5.9.9-4.3 4.1 1 5.8-5.2-2.7-5.2 2.7 1-5.8L3.5 9.7l5.9-.9z"/></Icon>,
