...
// appeals go to the Ivy support team, who approve (remove) or deny. Owners
      ...
      {reviews.length === 0 ? (
        <div className="card" style={{ padding: 40 }}>
          <EmptyNote icon="Heart" title="No reviews yet"
            hint="After a completed appointment, Ivy automatically asks clients for a review. New reviews publish here right away - you can respond to any of them." />
        </div>
      ) : (
        <>
