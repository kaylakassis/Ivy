...
export const POSTS = [
  {
    ...
    body: [
      ...
      { type: 'p', text: "Don't price at your ceiling - leave room for raises. Pricing in the upper third of your floor-to-ceiling range gives you space to raise prices yearly without losing your best clients. Ivy makes the math easy: open Finance → Reports → average session value and you've got your current number." },
  ...
  },
  {
    ...
    body: [
      ...
      { type: 'p', text: 'In Ivy: Documents → New from template. Three intakes are pre-loaded. Customize, attach to your service, and the form auto-sends on every booking.' },
    ],
  },
  {
  ...
  },
  {
    ...
    body: [
      ...
      { type: 'h', text: 'Where Ivy recovers each one' },
  ...
  },
  {
    ...
    body: [
      ...
      { type: 'p', text: "Standard rate ~2.9%+30¢. Money lands in your bank in 2 business days. Integrates with everything (Ivy included). No physical card reader hardware - but you can use Stripe Terminal for that. Best for: any solo who books online." },
      ...
      { type: 'p', text: "If you're 100% in-person walk-in: Square. Everyone else: Stripe. Ivy connects to your existing Stripe - we never take a cut of your sales." },
    ],
  },
  {
