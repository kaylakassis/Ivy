...
.site-root input[type=range]{width:100%;accent-color:#4CBA7F;cursor:pointer}
...
.site-root .calc-total{margin-top:16px;background:var(--tint);border:1px solid rgba(76,186,127,.3);border-radius:12px;padding:20px;display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:8px}
...
.site-root details[open]{border-color:rgba(76,186,127,.35)}
    ...
    <div className="site-root">
      ...
      <section className="center">
        <div className="container">
          ...
          <h2>Save about $99/mo - most solos spend $138/month or even more on stitched-together SaaS.</h2>
