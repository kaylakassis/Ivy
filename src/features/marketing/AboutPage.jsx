...
export default function AboutPage() {
  ...
  useEffect(() => {
    ...
    upsert('name', 'description', "Why THRYVE exists, what it actually is, and who's behind it. The all-in-one business OS for solo entrepreneurs.");
    upsert('property', 'og:title', 'About THRYVE');
    upsert('property', 'og:description', "Why THRYVE exists, what it actually is, and who's behind it.");
  }, []);
    ...
    <div className={`app-root dir-${tweaks.direction}`} style={{ minHeight: '100vh', background: 'var(--page)' }}>
      ...
      <section style={{ maxWidth: 720, margin: '0 auto', padding: '64px 24px 24px' }}>
        ...
        <p style={{
          ...
          shared logo. THRYVE is the opposite bet: one workspace where booking,
