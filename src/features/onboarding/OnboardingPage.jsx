...
import { TRIAL_DAYS, IVY_PRICE, STACK_TOTAL, IVY_PRICE_MONTHLY_EQUIV } from '../../lib/pricing.js';
...
function ImpactStep({ about, businessType }) {
  ...
  const stats = [
    ...
    { key: 'total',     label: 'Tools replaced',    value: `$${STACK_TOTAL}/mo → ~$${IVY_PRICE_MONTHLY_EQUIV}/mo`, sub: 'one app instead of a stack' },
  ];
  return (
