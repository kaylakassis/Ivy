...
//     - https://getthryve.ai            (production, marketed)
//     - https://thryve-pink.vercel.app  (default Vercel deploy URL — same project)
//     - http://localhost:5173           (local dev)
//   Operators using the second one would otherwise see and copy
//   "thryve-pink.vercel.app/book/handle" from the wizard / share
//   drawer, then paste a stale URL into Instagram. We want every
//   share-able URL to read getthryve.ai regardless of which host
//   they're currently loaded on, except in dev where localhost is
//   what actually works.
const CANONICAL = 'https://getthryve.ai';
